      ...
      <div className="relative z-20 w-full px-3 sm:px-4 md:px-6 lg:px-6 py-3 sm:py-4 flex items-center justify-between gap-2 sm:gap-4 mx-auto max-w-full lg:max-w-screen-xl lg:mx-auto">
        ...
        <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
          ...
          <Link
            ...
            className="relative flex items-center gap-1 sm:gap-2 text-sm font-medium hover:text-gray-600"
          >
            ...
            <div className="relative z-[60]" ref={accountMenuRef}>
              ...
              >
                ...
                <span className="hidden sm:inline">
                  {user.name || t("header.account", "Account")}
                </span>
              </button>
              <div
                className={`absolute right-0 mt-2 w-40 sm:w-48 rounded-lg border border-gray-200 bg-white shadow-lg z-[60] ${isAccountMenuOpen ? "block" : "hidden"}`}
              >
                <Link
                  href="/account"
