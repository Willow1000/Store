            ...
            return (
              ...
              >
                <div className="relative aspect-square bg-white">
                  ...
                  <span
                    className={`absolute bottom-2 left-2 rounded px-2 py-1 text-xs font-bold ${stock === 0 ? "bg-red-600 text-white" : "bg-white/90 text-gray-800"}`}
                  >
                  ...
                  <div className="absolute right-2 top-2 flex flex-col gap-2 opacity-0 transition-opacity group-hover:opacity-100">
                    {onWishlistToggle && (
                      ...
                      >
                        <Heart
                          className={`h-4 w-4 ${isWished ? "text-red-500" : "text-gray-600"}`}
                ...
                <div className="flex flex-1 flex-col p-3">
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    {[product.brand, product.model, product.category_name]
                      .filter(Boolean)
                      .slice(0, 2)
                      .join(" • ")}
                  </p>
