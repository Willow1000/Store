...
export const SEO_CONFIG = {
  ...
  site: {
    ...
    description:
      "Rare and hard-to-find European automotive parts marketplace for OEM and aftermarket components with trusted sourcing and fast shipping.",
  ...
  defaults: {
    title:
      "Rare European Car Parts | OEM and Aftermarket Auto Parts Europe | MotorVault",
    description:
      "Shop rare and hard-to-find European car parts for BMW, Mercedes, Volkswagen, Audi, Porsche, Opel, Fiat, Peugeot, Renault, and Volvo. OEM and aftermarket options with fast shipping in Europe.",
    keywords: [
      "European car parts",
  ...
  robots: {
    ...
    allowedLLMs: ["GPTBot", "CCBot", "anthropic-ai", "Claude-Web"],
    blockedBots: ["MJ12bot", "SemrushBot", "DotBot"],
    disallowPaths: ["/api/", "/admin/", "/account", "/orders", "/checkout"],
  },
  ...
  const pageConfigs: Record<string, any> = {
    ...
    product: {
      title: customData?.name
        ? `${customData.name} | ${SEO_CONFIG.site.name}`
