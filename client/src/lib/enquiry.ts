...
const COPY: Record<SiteLanguageCode, EnquiryCopy> = {
  en: {
    ...
    productEnquiryLine: title =>
      `I would like to enquire about this product: "${title}".`,
    outOfStockLine: title =>
      `I am interested in the product "${title}" which is currently out of stock.`,
    ...
    quickViewOutOfStockMessage: title =>
      `I am interested in the product "${title}" which is currently out of stock. Please let me know when it will be available again.`,
  },
  de: {
    productSubject: "Produktanfrage",
    outOfStockSubject: "Nicht auf Lager Anfrage",
    productEnquiryLine: title =>
      `Ich moechte eine Anfrage zu diesem Produkt stellen: "${title}".`,
    outOfStockLine: title =>
      `Ich interessiere mich fuer das Produkt "${title}", das derzeit nicht auf Lager ist.`,
    ...
    productOutOfStockAsk:
      "Bitte informieren Sie mich, sobald dieser Artikel wieder verfuegbar ist.",
    productGeneralAsk:
      "Bitte teilen Sie Verfuegbarkeit, Kompatibilitaet und die naechsten Bestellschritte mit.",
    ...
    quickViewOutOfStockMessage: title =>
      `Ich interessiere mich fuer das Produkt "${title}", das derzeit nicht auf Lager ist. Bitte informieren Sie mich, wenn es wieder verfuegbar ist.`,
  },
  it: {
    productSubject: "Richiesta prodotto",
    outOfStockSubject: "Richiesta prodotto non disponibile",
    productEnquiryLine: title =>
      `Vorrei richiedere informazioni su questo prodotto: "${title}".`,
    outOfStockLine: title =>
      `Sono interessato al prodotto "${title}", attualmente non disponibile.`,
    ...
    productOutOfStockAsk:
      "Per favore avvisami quando questo articolo tornera disponibile.",
    productGeneralAsk:
      "Condividi disponibilita, compatibilita e prossimi passi per ordinare.",
    ...
    quickViewOutOfStockMessage: title =>
      `Sono interessato al prodotto "${title}", attualmente non disponibile. Fammi sapere quando sara nuovamente disponibile.`,
  },
  fr: {
    productSubject: "Demande produit",
    outOfStockSubject: "Demande produit en rupture",
    productEnquiryLine: title =>
      `Je souhaite demander des informations sur ce produit : "${title}".`,
    outOfStockLine: title =>
      `Je suis interesse par le produit "${title}", actuellement en rupture de stock.`,
    ...
    productOutOfStockAsk:
      "Merci de me prevenir lorsque cet article sera de nouveau disponible.",
    productGeneralAsk:
      "Merci de partager la disponibilite, la compatibilite et les prochaines etapes de commande.",
    ...
    quickViewOutOfStockMessage: title =>
      `Je suis interesse par le produit "${title}", actuellement en rupture de stock. Merci de me prevenir lorsqu il sera disponible.`,
  },
  es: {
    productSubject: "Consulta de producto",
    outOfStockSubject: "Consulta de producto sin stock",
    productEnquiryLine: title =>
      `Quiero consultar sobre este producto: "${title}".`,
    outOfStockLine: title =>
      `Estoy interesado en el producto "${title}", que actualmente esta sin stock.`,
    ...
    productOutOfStockAsk:
      "Por favor avisame cuando este articulo vuelva a estar disponible.",
    productGeneralAsk:
      "Comparte disponibilidad, compatibilidad y los siguientes pasos para comprar.",
    ...
    quickViewOutOfStockMessage: title =>
      `Estoy interesado en el producto "${title}", que actualmente esta sin stock. Avisame cuando vuelva a estar disponible.`,
  },
  nl: {
    productSubject: "Productaanvraag",
    outOfStockSubject: "Niet op voorraad aanvraag",
    productEnquiryLine: title =>
      `Ik wil informatie over dit product: "${title}".`,
    outOfStockLine: title =>
      `Ik ben geinteresseerd in het product "${title}", dat momenteel niet op voorraad is.`,
    productLabel: "Product",
    ...
    productOutOfStockAsk:
      "Laat me weten wanneer dit artikel weer beschikbaar is.",
    productGeneralAsk:
      "Deel beschikbaarheid, compatibiliteit en de volgende bestelstappen.",
    ...
    quickViewOutOfStockMessage: title =>
      `Ik ben geinteresseerd in het product "${title}", dat momenteel niet op voorraad is. Laat me weten wanneer het weer beschikbaar is.`,
  },
};

export function getEnquiryCopy(
  language: SiteLanguageCode = getSiteLanguage()
): EnquiryCopy {
