...
const KEY_TRANSLATIONS: Record<SiteLanguageCode, Record<string, string>> = {
  de: {
    ...
    "checkout.phoneCountryCode": "Telefon-Ländervorwahl",
    "checkout.selectPhoneCountryCode": "Telefon-Ländervorwahl wählen",
    "checkout.streetAddress": "Straße und Hausnummer",
    "checkout.country": "Land",
    "checkout.selectCountry": "Land auswählen",
    "checkout.selectState": "Auswählen",
    "checkout.city": "Stadt",
    "checkout.selectCity": "Stadt auswählen",
  ...
  en: {
    ...
    "checkout.phoneCountryCode": "Phone country code",
    "checkout.selectPhoneCountryCode": "Select phone country code",
    "checkout.streetAddress": "Street Address",
    "checkout.country": "Country",
    "checkout.selectCountry": "Select country",
    "checkout.selectState": "Select",
    "checkout.city": "City",
  ...
  it: {
    ...
    "checkout.email": "Email",
    "checkout.phoneNumber": "Numero di telefono",
    "checkout.phoneCountryCode": "Prefisso internazionale",
    "checkout.selectPhoneCountryCode": "Seleziona il prefisso internazionale",
    "checkout.streetAddress": "Indirizzo",
    "checkout.country": "Paese",
    "checkout.selectCountry": "Seleziona il paese",
    "checkout.selectState": "Seleziona",
    "checkout.city": "Città",
    "checkout.selectCity": "Seleziona la città",
    "checkout.zipPlaceholder": "00100",
  ...
  fr: {
    ...
    "checkout.phoneCountryCode": "Indicatif du pays",
    "checkout.selectPhoneCountryCode": "Choisir l'indicatif du pays",
    "checkout.streetAddress": "Adresse",
    "checkout.country": "Pays",
    "checkout.selectCountry": "Choisir un pays",
    "checkout.selectState": "Choisir",
    "checkout.city": "Ville",
    "checkout.selectCity": "Choisir une ville",
  ...
  es: {
    ...
    "checkout.phoneCountryCode": "Código de país",
    "checkout.selectPhoneCountryCode": "Selecciona el código de país",
    "checkout.streetAddress": "Dirección",
    "checkout.country": "País",
    "checkout.selectCountry": "Selecciona un país",
    "checkout.selectState": "Selecciona",
    "checkout.city": "Ciudad",
    "checkout.selectCity": "Selecciona una ciudad",
    "checkout.zipPlaceholder": "28001",
  ...
  nl: {
    ...
    "checkout.email": "E-mail",
    "checkout.phoneNumber": "Telefoonnummer",
    "checkout.phoneCountryCode": "Landnummer",
    "checkout.selectPhoneCountryCode": "Kies landnummer",
    "checkout.streetAddress": "Straat en huisnummer",
    "checkout.country": "Land",
    "checkout.selectCountry": "Kies een land",
    "checkout.selectState": "Kies",
    "checkout.city": "Plaats",
    "checkout.selectCity": "Kies een plaats",
    "checkout.zipPlaceholder": "1011 AB",
